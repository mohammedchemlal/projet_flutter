...
String newName="";
String usernam=globals.globalDataP;
...
class infosBasiquesProf extends StatelessWidget {
  const infosBasiquesProf({Key? key}) : super(key: key);
      ...
      body: Container(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                leading:Image.asset("assets/prof/edit.png"),
